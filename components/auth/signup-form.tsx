...
export function SignupForm() {
  ...
  return (
    <Card className="w-full max-w-md backdrop-blur-md bg-white/10 border-white/20 text-white">
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-gray-300">
          Join thousands of students who've transformed their productivity
        </CardDescription>
      </CardHeader>
      <CardContent>
